...
function Section({ title, children }) {
  return (
    <section className="mb-6">
      <h4 className="mb-3 text-sm font-bold uppercase tracking-wide text-emerald-700">
        {title}
      </h4>
      ...
      <div className="flex max-h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-lg bg-white shadow-2xl">
        ...
        <div className="overflow-y-auto px-5 py-5">
          ...
          <Section title="Residencia en Quito">
            <FieldGrid
              data={residencia}
              order={["tiempoResidenciaQuito", "motivoSalidaCiudadNatal"]}
            />
          </Section>
          ...
          <Section title="Vivienda actual">
            <FieldGrid
              ...
              order={[
                "tipoVivienda",
                "viviendaFamiliarQuien",
                "viviendaPrestadaQuien",
                "viviendaOtraEspecifique",
              ]}
            />
          </Section>
          ...
          <Section title="Observaciones e informacion adicional">
            <FieldGrid
              data={observaciones}
              order={["observacionesAdicionales", "sinExperienciaLaboral"]}
            />
          </Section>
          ...
          <Section title="Metadata">
            <FieldGrid
              data={metadata}
              order={["fecha_envio", "origen", "version_formulario"]}
            />
          </Section>
        </div>
      </div>
