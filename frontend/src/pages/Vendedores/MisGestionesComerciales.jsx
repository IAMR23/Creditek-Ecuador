...
export default function MisGestionesComerciales() {
  ...
  const fetchData = async () => {
    ...
    try {
      const url = `${API_URL}/api/gestion-comercial/vendedor/${usuarioInfo.agenciaPrincipal.usuarioAgenciaId}?fechaInicio=${fechaInicio}&fechaFin=${fechaFin}&solicitud=${solicitud}&origen=${origen}&region=${region}`;
