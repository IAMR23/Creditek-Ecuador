...
const GhlRepartoTiempoRealConfiguracion = require('./GhlRepartoTiempoRealConfiguracion');
...
GhlRepartoTiempoRealConfiguracion.belongsTo(Usuario, { foreignKey: "actualizadoPorId", as: "actualizadoPor" });
GhlRepartoEjecucion.belongsTo(Usuario, { foreignKey: "ejecutadoPorId", as: "ejecutadoPor" });
GhlAsesorVinculo.belongsTo(Usuario, { foreignKey: "usuarioId", as: "usuario" });
GhlAsesorVinculo.belongsTo(Usuario, { foreignKey: "estadoCambiadoPorId", as: "estadoCambiadoPor" });
Usuario.hasOne(GhlAsesorVinculo, { foreignKey: "usuarioId", as: "ghlAsesorVinculo" });
GhlAsesorVinculo.hasMany(GhlAsesorDisponibilidadHistorial, { foreignKey: "vinculoId", as: "historialDisponibilidad" });
GhlAsesorDisponibilidadHistorial.belongsTo(GhlAsesorVinculo, { foreignKey: "vinculoId", as: "vinculo" });
GhlAsesorDisponibilidadHistorial.belongsTo(Usuario, { foreignKey: "usuarioId", as: "asesor" });
GhlAsesorDisponibilidadHistorial.belongsTo(Usuario, { foreignKey: "cambiadoPorId", as: "cambiadoPor" });
GhlWorkflowProgramacion.hasMany(GhlWorkflowEjecucion, { foreignKey: "configuracionId", as: "ejecuciones" });
GhlWorkflowEjecucion.belongsTo(GhlWorkflowProgramacion, { foreignKey: "configuracionId", as: "configuracion" });
GhlWorkflowEjecucion.hasMany(GhlWorkflowEjecucionDetalle, { foreignKey: "ejecucionId", as: "detalles" });
