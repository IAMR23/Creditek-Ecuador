...
const GhlRepartoEjecucion = sequelize.define("GhlRepartoEjecucion", {
  ...
  totalPlanificadas: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
  ...
  totalOmitidasCambioEtapa: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
  totalOmitidasAsesorPausado: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
  totalOmitidasPropietarioCambiado: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
  totalPendientesCapacidad: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 0 },
