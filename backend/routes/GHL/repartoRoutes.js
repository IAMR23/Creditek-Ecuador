...
router.get("/mi-disponibilidad", controller.myAvailability);
router.patch("/mi-disponibilidad", controller.setMyAvailability);
router.get("/reporte-gestiones", requirePermission("Supervisores", "Gerencia", "Administracion", "Sistemas"), controller.advisorManagementReport);
